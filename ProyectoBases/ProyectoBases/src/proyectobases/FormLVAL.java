 ...
 * @author eljul
 */
public class FormLVAL extends javax.swing.JFrame {
...
//        //ActualizarCBs();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Conectar();
        try {
            String query ="Insert into LVAL(LVAL.TIPOLVAL, LVAL.IDLVAL, LVAL.DESCRIPCION) VALUES ( \'" + jTextField1.getText() + "\', \'" + jTextField5.getText() + "\', \'"  + jTextArea1.getText() +"\')";
            rs = st.executeQuery(query);
            JOptionPane.showMessageDialog(this, "Se ingreso el valor de " + jTextField1.getText() + " " + jTextField5.getText() + " correctamente");
        } catch (Exception e) {
            ...
            try {
                ...
                Logger.getLogger(FormLVAL.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        ActualizarCBs();
...
//        ActualizarCBs();
    ...
    private void CBModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CBModificarMouseClicked
        ...
        Conectar();
        try {
            String query ="Select LVAL.TIPOLVAL, LVAL.IDLVAL from LVAL";
            rs = st.executeQuery(query);
            ...
            for(int i = 0; i < lista.size(); i++){
                CBModificar.addItem(lista.get(i) + "-" + lista2.get(i));
            }
        } catch (Exception e) {
    ...
    private void CBEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CBEliminarMouseClicked
        ...
        try {
            ...
            RealizarCommit();
            for(int i = 0; i < lista.size(); i++){
                CBEliminar.addItem(lista.get(i) + "-" + lista2.get(i));
            }
        } catch (Exception e) {
            System.out.println("Error al actualizar los datos de bancos");
        }        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormLVAL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
