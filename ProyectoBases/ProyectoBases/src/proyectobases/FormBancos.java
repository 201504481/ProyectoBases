 ...
 * @author eljul
 */
public class FormBancos extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Conectar();
        try {
            String query ="Insert into BANCO(BANCO.nombre) VALUES ( \'" + jTextField1.getText() + "\')";
            rs = st.executeQuery(query);
            JOptionPane.showMessageDialog(this, "Se ingreso el banco " + jTextField1.getText() + " correctamente");
        } catch (Exception e) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Conectar();
        try {
            String query = "delete from BANCO where BANCO.IDBANCO = " + CBEliminar.getItemAt(CBEliminar.getSelectedIndex()).toString();
            System.out.println(query);
            rs = st.executeQuery(query);
    ...
    private void CBEliminarItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CBEliminarItemStateChanged
        Conectar();
        try {
            String query = "Select BANCO.NOMBRE from BANCO where BANCO.IDBANCO = " + CBEliminar.getItemAt(CBEliminar.getSelectedIndex()).toString();
            rs = st.executeQuery(query);
    ...
    public void ActualizarCBs(){
        ...
        Conectar();
        try {
            String query ="Select BANCO.IDBANCO from BANCO";
            rs = st.executeQuery(query);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormBancos().setVisible(true);
            }
        });
    }
